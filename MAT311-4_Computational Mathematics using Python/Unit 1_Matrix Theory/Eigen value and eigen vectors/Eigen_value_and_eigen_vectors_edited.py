...
# 8. For idempotent matrix the eigenvalues are 0 and 1(Aˆ2=identity matrix).
...
# Given the matrix A, let the matrix of eigen vectors of A be P and 
# inverse OF P be I.
